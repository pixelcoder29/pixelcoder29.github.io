...
- Services are billed monthly in advance for weekly visits.  
- All payments are final. No refunds, partial refunds, or credits are issued for services already charged.  
...
- Service will continue through the end of your current billing cycle unless you explicitly request that no further visits occur.  
- Charges for visits within the current billing period are non-refundable.

---

## 5. Service Timing & Policies

- **First Service:** Scheduled 7–13 days after sign-up, depending on routing and availability.  
- **Service Duration:** Typically 10–15 minutes per visit; first pickups or yards with multiple piles may take longer, up to 1 hour or more.  

**Pets & Access:**  
- Pets must be secured during service.  
- If pets are outside or the yard is inaccessible, we will attempt to contact you twice by phone, once by door knock, and once via text.  
- If we cannot reach you, the service will be skipped for that day but counted as completed.  
- No refunds will be issued for missed service due to access or pet safety issues.

**Right to Adjust Schedule / Service Modifications:**  
- Yard Guards PDX reserves the right to adjust service day and/or time windows to optimize routing, staffing, and service efficiency. Customers will be notified in advance.  
...
**Customer Note:**  
- Please keep pets secured for the full service window to ensure safe and complete service.

---

## 6. Promotional Services

Any free promotional services, including the first pickup, have no cash value and are not refundable.
...
All issues are reviewed case-by-case. Any resolution offered is at the sole discretion of Yard Guards PDX and does not constitute a refund, credit, or guarantee of compensation.

---

## 8. Pet & Yard Safety

- All pets must be indoors or securely restrained away from the service area during service.  
- Staff are trained and experienced but cannot perform services safely if pets are unsecured.  
...
- Consent is required to feature your yard; contact [service@yardguardspdx.com](mailto:service@yardguardspdx.com).  
...
Yard Guards PDX is not responsible for delays or missed services due to events beyond our reasonable control, including weather, natural disasters, or other unforeseen circumstances.
...
The most current version will be posted on our website. Continued use of our services constitutes acceptance of any changes.
...
By signing up, you consent to receive service-related communications electronically via email or text, including service reminders, on-the-way notifications, invoices, and important updates regarding your account or scheduled visits.
...
You can opt out of receiving marketing communications at any time by clicking the unsubscribe link in any email or replying "STOP" to any SMS.  
Service-related texts and emails (e.g., on-the-way notifications, receipts) will continue as part of your service agreement.
