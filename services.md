...
<div class="full-bleed-wrapper" style="background:#ffffff;">
  <div class="section-inner">
    <h2 style="text-align:center; margin-bottom:40px;">Choose Your Service Frequency</h2>
...
<div class="full-bleed-wrapper" style="background:#f8f8f8;">
  <div class="section-inner">
    <h2 style="text-align:center; margin-bottom:40px;">How Our Service Works</h2>
    ...
    <div class="how-it-works">
      ...
      <div class="step">
        ...
        <p>Choose your preferred service frequency and we'll coordinate the best times for your regular cleanups.</p>
      </div>
...
<div class="full-bleed-wrapper" style="background:#ffffff;">
  <div class="section-inner" style="text-align:center;">
    ...
    <p style="font-size:20px; margin-bottom:32px; color: #1a1a1a;">Get your personalized quote today and experience the convenience of professional pet waste removal.</p>
    <button class="open-form-btn cta-button">Get Your Free Quote</button>
  </div>
</div>
